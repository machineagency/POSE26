...
**Code understanding** — open `DemoOfAllTools.ipynb` and ask:
...
If the answers reference the correct science-jubilee API (not Opentrons or Hamilton), your setup is working.
...
- **Add workflows**: Create new notebooks in `examples/`
